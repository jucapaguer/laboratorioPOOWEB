...
<html lang="es">
    ...
    <!--Dentro de este segmento es donde son almacenados los datos que fueron enviados
        anteriormente de la pagina registroMateria, luego son enviados atraves de los SETs a un metodo que ya
    ...
    <%
        ...
        intensidad = Integer.parseInt(request.getParameter("Intensidad"));
       
        Materia nuevaMateria = new Materia();

        nuevaMateria.setNombre_materia(nombre);
        nuevaMateria.setIntensidad(intensidad);
        
        repo.adicionarMateria(nuevaMateria);
