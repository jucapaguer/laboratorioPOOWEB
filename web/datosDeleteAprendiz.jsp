...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <!--
            Dentro de este segmento es recivido el codigo enviado de la pagina "tabla" dentro del cual
            ...
            Terminado este proceso la pagina se cerrar y pasara a la pagina tabla
        -->
        <%
            ...
            Aprendiz deleteAprendiz = new Aprendiz();

            deleteAprendiz.setId_aprendices(codigo);

            repo.eliminarAprendiz(deleteAprendiz);
