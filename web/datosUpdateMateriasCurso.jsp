...
<html lang="es">
    ...
    <%
        ...
        Fk_materia = Integer.parseInt(request.getParameter("fk_materia"));
        Fk_curso = Integer.parseInt(request.getParameter("fk_curso"));

        MateriaCurso updateMateriaCurso = new MateriaCurso();

        updateMateriaCurso.setId_materias_curso(Id);
        updateMateriaCurso.setFk_materia(Fk_materia);
        updateMateriaCurso.setFk_curso(Fk_curso);

        repo.editarMateriaCurso(updateMateriaCurso);
    %>
                            ...
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <%
                                                List<Materia> lista = repo.findMateriaByIdMateria(Fk_materia);
                                        ...
                                        <th>
                                            <%
                                                List<Curso> lista2 = repo.findCursoByIdCurso(Fk_curso);
