...
<html lang="en">
    ...
    <body id="page-top">
        <!-- Page Wrapper -->
         <!--
            Dentro de este segmento es recivido el codigo enviado de la pagina "tablamateria" dentro del cual
            ...
            Terminado este proceso la pagina se cerrar y pasara a la pagina tablaMateria
        -->
         <%
            ...
            Materia deleteMateria = new Materia();

            deleteMateria.setId_materias(codigo);

            repo.eliminarMateria(deleteMateria);
