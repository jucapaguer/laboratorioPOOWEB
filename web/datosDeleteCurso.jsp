...
<html lang="en">
    ...
    <body id="page-top">
        <!-- Page Wrapper -->
         <!--
            Dentro de este segmento es recivido el codigo enviado de la pagina "tablacurso" dentro del cual
            ...
            Terminado este proceso la pagina se cerrar y pasara a la pagina tablacurso
        -->
         <%
            ...
            deleteCurso.setId_cursos(codigo);

            repo.eliminarCurso(deleteCurso);
